...
//        System.out.println(decrypt);
     ...
     */
    public static byte[] AESEncrypt(String data, String key, String iv) throws NoSuchPaddingException, NoSuchAlgorithmException, UnsupportedEncodingException, InvalidAlgorithmParameterException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
     ...
     * @throws UnsupportedEncodingException
     */
    public static byte[] Base64Decrypt(String data) throws UnsupportedEncodingException {
     ...
     * @throws NoSuchAlgorithmException
     */
    public static String randomString(int bits) throws NoSuchAlgorithmException {
